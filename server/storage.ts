...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const sampleCases: Case[] = [
      ...
      // Additional cases for comprehensive UI/UX review
      {
        id: "case-5",
        siteId: "site-2",
        caseReference: "EL-2024-004",
        employeeName: "David Thompson",
        employeeId: "EMP-7891",
        caseType: "redundancy",
        status: "open",
        description: "Proposed redundancy due to warehouse restructuring - consultation period started",
        isConfidential: false,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000),
        resolutionDate: null,
        assignedConsultant: "user-1",
        createdBy: "user-1",
        createdAt: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000),
      ...
      },
      {
        id: "case-6",
        siteId: "site-2",
        caseReference: "EL-2024-005",
        employeeName: "Rachel Green",
        employeeId: "EMP-4521",
        caseType: "tupe",
        status: "under_investigation",
        description: "TUPE transfer consultation - employee transferring from acquired logistics company",
        isConfidential: false,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000),
        resolutionDate: null,
        assignedConsultant: "user-1",
        createdBy: "user-admin",
        createdAt: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000),
      ...
      },
      {
        id: "case-7",
        siteId: "site-1",
        caseReference: "EL-2024-006",
        employeeName: "James Morrison",
        employeeId: "EMP-8832",
        caseType: "appeal",
        status: "hearing_scheduled",
        description: "Appeal against written warning issued following absence review",
        isConfidential: true,
        restrictedToUsers: null,
        hearingDate: new Date(now.getTime() + 10 * 24 * 60 * 60 * 1000),
        responseDeadline: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000),
        resolutionDate: null,
        assignedConsultant: "user-1",
        createdBy: "user-1",
      ...
      },
      {
        id: "case-8",
        siteId: "site-1",
        caseReference: "EL-2023-012",
        employeeName: "Linda Patterson",
        employeeId: "EMP-2234",
        caseType: "investigation",
        status: "closed",
        description: "Investigation into alleged breach of confidentiality - no case to answer",
        isConfidential: true,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: null,
        resolutionDate: new Date(now.getTime() - 45 * 24 * 60 * 60 * 1000),
        assignedConsultant: "user-1",
        createdBy: "user-admin",
        createdAt: new Date(now.getTime() - 90 * 24 * 60 * 60 * 1000),
      ...
      },
      {
        id: "case-9",
        siteId: "site-2",
        caseReference: "EL-2024-007",
        employeeName: "Mark Williams",
        employeeId: "EMP-6672",
        caseType: "grievance",
        status: "resolved",
        description: "Grievance regarding working conditions in warehouse - improvements implemented",
        isConfidential: false,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: null,
        resolutionDate: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000),
        assignedConsultant: "user-1",
        createdBy: "user-1",
        createdAt: new Date(now.getTime() - 25 * 24 * 60 * 60 * 1000),
        updatedAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000),
      },
      {
        id: "case-10",
        siteId: "site-1",
        caseReference: "EL-2024-008",
        employeeName: "Sophie Clark",
        employeeId: "EMP-9923",
        caseType: "disciplinary",
        status: "open",
        description: "Alleged violation of health and safety procedures - initial investigation",
        isConfidential: true,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000),
        resolutionDate: null,
        assignedConsultant: "user-1",
        createdBy: "user-1",
        createdAt: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000),
      ...
      },
      {
        id: "case-11",
        siteId: "site-1",
        caseReference: "EL-2023-018",
        employeeName: "Robert Hughes",
        employeeId: "EMP-1156",
        caseType: "settlement",
        status: "closed",
        description: "COT3 settlement agreement - mutual termination with agreed terms",
        isConfidential: true,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: null,
        resolutionDate: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000),
        assignedConsultant: "user-1",
        createdBy: "user-admin",
        createdAt: new Date(now.getTime() - 120 * 24 * 60 * 60 * 1000),
      ...
      },
      {
        id: "case-12",
        siteId: "site-2",
        caseReference: "EL-2024-009",
        employeeName: "Jennifer Adams",
        employeeId: "EMP-3387",
        caseType: "tribunal_claim",
        status: "under_investigation",
        description: "ET1 received - discrimination claim based on pregnancy - ACAS early conciliation in progress",
        isConfidential: true,
        restrictedToUsers: null,
        hearingDate: null,
        responseDeadline: new Date(now.getTime() + 21 * 24 * 60 * 60 * 1000),
        resolutionDate: null,
        assignedConsultant: "user-1",
        createdBy: "user-1",
