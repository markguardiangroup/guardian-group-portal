...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    // Create folders for the sample cases first
    const caseFolders: DocumentFolder[] = [
      {
        id: "folder-case-1",
        name: "EL-2024-001 - John Smith",
        description: "Documents for case EL-2024-001",
      ...
      {
        id: "folder-case-2",
        name: "EL-2024-002 - Sarah Mitchell",
        description: "Documents for case EL-2024-002",
        module: "employment_law",
        siteId: "site-1",
        parentId: null,
        templateId: null,
      ...
      {
        id: "folder-case-3",
        name: "EL-2024-003 - Emma Wilson",
        description: "Documents for case EL-2024-003",
        module: "employment_law",
        siteId: "site-1",
        parentId: null,
        templateId: null,
    ...
    const sampleCases: Case[] = [
      // Case 1: Active Disciplinary - Under Investigation with extensive activity
      {
        ...
        entityId: "company-1",
        siteId: "site-1",
        folderId: "folder-case-1",
        caseReference: "EL-2024-001",
        employeeName: "John Smith",
        employeeId: "EMP-1234",
        caseType: "disciplinary",
        status: "under_investigation",
        description: "Investigation into alleged misconduct relating to expenses claims. Employee allegedly submitted duplicate expense claims for business travel over a 6-month period totaling approximately £3,200. Initial review of finance records flagged discrepancies. HR notified on 16th January.",
        isConfidential: true,
      ...
      // Case 2: Grievance - Open with initial acknowledgment completed
      {
        ...
        entityId: "company-1",
        siteId: "site-1",
        folderId: "folder-case-2",
        caseReference: "EL-2024-002",
        employeeName: "Sarah Mitchell",
        employeeId: "EMP-5678",
        caseType: "grievance",
        status: "open",
        description: "Formal grievance raised regarding alleged workplace bullying by line manager. Employee reports feeling marginalized in team meetings, being excluded from key communications, and experiencing unwarranted criticism of work. Grievance submitted in writing on 23rd January with supporting evidence of email exchanges.",
        isConfidential: true,
        restrictedToUsers: null,
        hearingDate: null,
      ...
      // Case 3: Tribunal Claim - Hearing Scheduled with full documentation trail
      {
        ...
        entityId: "company-1",
        siteId: "site-1",
        folderId: "folder-case-3",
        caseReference: "EL-2024-003",
        employeeName: "Emma Wilson",
        employeeId: "EMP-3456",
        caseType: "tribunal_claim",
        status: "hearing_scheduled",
        description: "ET1 claim received for unfair dismissal following redundancy selection. Claimant alleges selection criteria were not fairly applied and consultation was inadequate. ACAS early conciliation certificate obtained. ET3 response filed. Preliminary hearing completed, full merits hearing scheduled for March 2026.",
        isConfidential: true,
        restrictedToUsers: null,
    ...
    // Sample Case Milestones - Rich activity across all 3 cases
    const sampleMilestones: CaseMilestone[] = [
      // Case 1 Milestones (Disciplinary)
      {
        id: "milestone-1",
        caseId: "case-1",
        title: "Initial fact-finding review",
        description: "Review finance records and identify discrepancies in expense claims",
        dueDate: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000),
        completedDate: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000),
        isCompleted: true,
        createdBy: "user-1",
        createdAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        description: "Conduct formal investigation meeting with John Smith - right to be accompanied explained",
      ...
      },
      {
        ...
        description: "Collect statements from Finance team (A. Davis) and line manager (P. Roberts)",
      ...
      },
      {
        ...
        description: "Prepare full investigation report with findings and recommendations",
      ...
      },
      {
        ...
        description: "Formal disciplinary hearing - employee to be given 5 days notice",
      ...
      // Case 2 Milestones (Grievance)
      {
        id: "milestone-6",
        caseId: "case-2",
        title: "Acknowledge grievance",
        description: "Send formal written acknowledgment within 5 working days of receipt",
      ...
      },
      {
        id: "milestone-7",
        caseId: "case-2",
        title: "Appoint grievance hearing manager",
        description: "Identify appropriate manager (not involved in allegations) to hear grievance",
      ...
      },
      {
        ...
        description: "Arrange formal grievance hearing with employee - explain right to be accompanied",
        dueDate: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000),
        completedDate: null,
        isCompleted: false,
        createdBy: "user-1",
      ...
      },
      {
        ...
        description: "Review email exchanges and any other documentation provided by employee",
      ...
      // Case 3 Milestones (Tribunal Claim)
      {
        id: "milestone-10",
        caseId: "case-3",
        title: "Obtain ACAS early conciliation certificate",
        description: "Confirm ACAS certificate received and record reference number",
        dueDate: new Date(now.getTime() - 55 * 24 * 60 * 60 * 1000),
        completedDate: new Date(now.getTime() - 56 * 24 * 60 * 60 * 1000),
        isCompleted: true,
        createdBy: "user-1",
        createdAt: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000),
      },
      {
        id: "milestone-11",
        caseId: "case-3",
        title: "File ET3 response",
        description: "Submit response to Employment Tribunal within 28-day deadline",
        dueDate: new Date(now.getTime() - 32 * 24 * 60 * 60 * 1000),
        completedDate: new Date(now.getTime() - 35 * 24 * 60 * 60 * 1000),
        isCompleted: true,
        createdBy: "user-1",
      ...
      },
      {
        id: "milestone-12",
        caseId: "case-3",
        title: "Attend preliminary hearing",
        description: "Case management preliminary hearing at Manchester Employment Tribunal",
        dueDate: new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000),
      ...
      },
      {
        ...
        description: "Exchange witness statements as per Tribunal directions",
        dueDate: new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000),
        completedDate: null,
        isCompleted: false,
        createdBy: "user-1",
      ...
      },
      {
        ...
        description: "Compile agreed bundle of documents for Tribunal hearing",
      ...
      },
      {
        id: "milestone-15",
        caseId: "case-3",
        title: "Full merits hearing",
        description: "2-day hearing at Manchester Employment Tribunal - attendance required",
    ...
    const elDocs: Document[] = [
      // Case 1 Documents (Disciplinary)
      {
        id: "doc-el-1",
        title: "Finance Discrepancy Report",
        description: "Initial report from Finance identifying duplicate expense claims",
        module: "employment_law",
        ...
        documentTypeId: null,
        folderId: "folder-case-1",
        fileName: "finance_discrepancy_report.pdf",
        fileUrl: null,
        fileSize: 89000,
        mimeType: "application/pdf",
        version: 1,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
      ...
      {
        id: "doc-el-2",
        title: "Investigation Meeting Notes - J. Smith",
        description: "Notes from investigation meeting held on 20th January 2024",
        module: "employment_law",
        type: "case_notes",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-1",
        fileName: "investigation_meeting_notes_jsmith.pdf",
        fileUrl: null,
        fileSize: 156000,
        mimeType: "application/pdf",
        version: 1,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
      ...
      {
        id: "doc-el-3",
        title: "Witness Statement - A. Davis (Finance)",
        description: "Witness statement from Finance team member regarding expense processing",
        module: "employment_law",
      ...
      // Case 2 Documents (Grievance)
      {
        id: "doc-el-4",
        title: "Grievance Letter - S. Mitchell",
        description: "Original formal grievance submission dated 23rd January 2024",
        module: "employment_law",
        type: "case_notes",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-2",
        fileName: "grievance_letter_smitchell.pdf",
        fileUrl: null,
        fileSize: 45000,
        mimeType: "application/pdf",
        version: 1,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000),
        renewalDate: null,
      ...
      {
        id: "doc-el-5",
        title: "Grievance Acknowledgment Letter",
        description: "Formal acknowledgment letter sent to employee",
        module: "employment_law",
        type: "correspondence",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-2",
        fileName: "grievance_acknowledgment.pdf",
        fileUrl: null,
        fileSize: 32000,
        mimeType: "application/pdf",
        version: 1,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
      ...
      {
        id: "doc-el-6",
        title: "Email Evidence Bundle",
        description: "Supporting email evidence provided by grievant",
        module: "employment_law",
        type: "case_notes",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-2",
        fileName: "email_evidence_bundle.pdf",
        fileUrl: null,
        fileSize: 890000,
        mimeType: "application/pdf",
        version: 1,
      ...
      // Case 3 Documents (Tribunal Claim)
      {
        id: "doc-el-7",
        title: "ET1 Claim Form",
        description: "Original Employment Tribunal claim form received",
        module: "employment_law",
        type: "legal_document",
        entityId: "company-1",
        siteId: "site-1",
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 58 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
        ...
        templateVersion: null,
        createdAt: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000),
        updatedAt: new Date(now.getTime() - 58 * 24 * 60 * 60 * 1000),
      },
      {
        id: "doc-el-8",
        title: "ET3 Response Form",
        description: "Employer response to Tribunal claim",
        module: "employment_law",
        type: "legal_document",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-3",
        fileName: "et3_response_form.pdf",
        fileUrl: null,
        fileSize: 234000,
        mimeType: "application/pdf",
        version: 2,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 35 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
      ...
      {
        id: "doc-el-9",
        title: "ACAS Early Conciliation Certificate",
        description: "Certificate confirming ACAS early conciliation completed",
        module: "employment_law",
        type: "legal_document",
        entityId: "company-1",
        siteId: "site-1",
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 56 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
        ...
        templateVersion: null,
        createdAt: new Date(now.getTime() - 58 * 24 * 60 * 60 * 1000),
        updatedAt: new Date(now.getTime() - 56 * 24 * 60 * 60 * 1000),
      },
      {
        id: "doc-el-10",
        title: "Preliminary Hearing Case Management Order",
        description: "Tribunal directions from preliminary hearing",
        module: "employment_law",
        type: "legal_document",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-3",
        fileName: "preliminary_hearing_order.pdf",
        fileUrl: null,
        fileSize: 67000,
        mimeType: "application/pdf",
        version: 1,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 12 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-1",
        assignedTo: null,
        isArchived: false,
      ...
      {
        id: "doc-el-11",
        title: "Redundancy Selection Matrix",
        description: "Original redundancy selection scoring documentation",
        module: "employment_law",
        type: "case_notes",
        entityId: "company-1",
        siteId: "site-1",
        ...
        documentTypeId: null,
        folderId: "folder-case-3",
        fileName: "redundancy_selection_matrix.xlsx",
        fileUrl: null,
        fileSize: 125000,
        ...
        reviewDate: null,
        expiryDate: null,
        lastApprovedAt: new Date(now.getTime() - 50 * 24 * 60 * 60 * 1000),
        renewalDate: null,
        uploadedBy: "user-client-1",
        assignedTo: null,
        isArchived: false,
    ...
    // Insert case documents into database (not in-memory) for getCaseDocuments to work
    this.seedCaseDocuments(elDocs);
    
    // Employment Law audit logs - comprehensive activity trail
    const elAuditLogs: AuditLog[] = [
      // Case 1 Activity (Disciplinary)
      {
        id: "audit-el-1",
        action: "case_created",
        userId: "user-1",
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Case EL-2024-001 created for John Smith - Disciplinary investigation",
        metadata: null,
        createdAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Finance Discrepancy Report uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Milestone 'Initial fact-finding review' created",
        metadata: null,
        createdAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Milestone 'Initial fact-finding review' completed",
        metadata: null,
        createdAt: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000),
      },
      {
      ...
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Investigation Meeting Notes uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 6 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Witness Statement - A. Davis uploaded (pending review)",
        metadata: null,
        createdAt: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000),
      },
      // Case 2 Activity (Grievance)
      {
        id: "audit-el-9",
        action: "case_created",
        userId: "user-1",
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Case EL-2024-002 created for Sarah Mitchell - Grievance",
        metadata: null,
        createdAt: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Grievance Letter uploaded by client",
        metadata: null,
        createdAt: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Email Evidence Bundle uploaded by client",
        metadata: null,
        createdAt: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Milestone 'Acknowledge grievance' completed",
        metadata: null,
        createdAt: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Grievance Acknowledgment Letter uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000),
      },
      // Case 3 Activity (Tribunal Claim)
      {
        id: "audit-el-14",
        action: "case_created",
        userId: "user-1",
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Case EL-2024-003 created for Emma Wilson - Tribunal Claim",
        metadata: null,
        createdAt: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "ET1 Claim Form uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 60 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Milestone 'Obtain ACAS early conciliation certificate' completed",
        metadata: null,
      ...
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "ACAS Early Conciliation Certificate uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 56 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        entityId: "company-1",
        siteId: null,
        documentId: "doc-el-11",
        caseId: "case-3",
        supportRequestId: null,
        module: "employment_law",
        details: "Redundancy Selection Matrix uploaded by client",
        metadata: null,
        createdAt: new Date(now.getTime() - 55 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Milestone 'File ET3 response' completed",
        metadata: null,
      ...
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "ET3 Response Form uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 35 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Case status changed from under_investigation to hearing_scheduled",
        metadata: null,
        createdAt: new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        supportRequestId: null,
        module: "employment_law",
        details: "Milestone 'Attend preliminary hearing' completed",
        metadata: null,
        createdAt: new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000),
      },
      {
        ...
        entityId: "company-1",
        siteId: null,
        documentId: "doc-el-10",
        caseId: "case-3",
        supportRequestId: null,
        module: "employment_law",
        details: "Preliminary Hearing Case Management Order uploaded",
        metadata: null,
        createdAt: new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000),
      },
    ];
    // Insert case audit logs into database (not in-memory) for getCaseAuditLogs to work
    this.seedCaseAuditLogs(elAuditLogs);
