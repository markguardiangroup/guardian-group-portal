  ...
  return (
    <div className="p-6 space-y-5" data-testid="folder-list-view">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Client Uploads</h1>
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30" data-testid="expiry-info-banner">
        ...
        <p className="text-sm text-amber-800 dark:text-amber-300">
          ...
          the folder is created. Files cannot be individually extended — create a new folder if you need
          longer-term storage.
        </p>
      </div>
