            ...
            <Card data-testid="card-compliance-summary">
              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="flex items-center gap-4" data-testid="card-module-score">
                    {/* Small pie chart */}
                    ...
                    <div className="shrink-0">
                      <p className={`text-3xl font-bold leading-none ${scoreColor}`}>{summary.complianceScore}%</p>
                    ...
                    <button
                      ...
                      className={`flex-1 flex flex-col items-center gap-1 py-3 px-2 rounded-lg border transition-colors ${summary.compliantDocuments > 0 ? "cursor-pointer bg-emerald-50/60 dark:bg-emerald-900/10 border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 dark:hover:bg-emerald-900/20" : "cursor-default border-border"}`}
                      data-testid="card-module-compliant"
                    >
                      <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 leading-none">{summary.compliantDocuments}</p>
