              ...
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center gap-5">
                    ...
                    <div className="relative" data-testid="card-module-score">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <div className="text-center">
                          <span className={`text-3xl font-bold ${scoreColor}`}>{summary.complianceScore}%</span>
                    ...
                    <div className="w-full grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <p className="text-3xl font-bold text-emerald-600 dark:text-emerald-400 leading-none">{summary.compliantDocuments}</p>
                        <p className="text-sm text-muted-foreground">Compliant</p>
                        {summary.compliantDocuments > 0 && <span className="text-xs text-muted-foreground/50">View</span>}
                      </button>
