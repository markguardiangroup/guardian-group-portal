    ...
    <div className="theme-training flex flex-col h-full">
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        ...
        {isProConsultant && (
          ...
          >
            <SelectTrigger className="w-[205px] text-sm" data-testid="select-pro-staff-filter-training">
              <span className="truncate pointer-events-none">
                {proStaffFilter === "my"
                  ? "My client sites"
                  : proStaffFilter === "all"
            ...
            <SelectContent>
              ...
              {myStaff.map(s => (
                <SelectItem key={s.id} value={s.id} data-testid={`pro-staff-filter-training-${s.id}`}>
